...
/*
    ...
    основном с тем, что для современных процессоров дорого работать со
    случайными обращениями в память.
    ...
    добавления элементов. Другой пример это в функциональных языках.
*/
